...
```
[완료] 이미지 불러오기 성공: .../images/dabo.jpg
[정보] 이미지 크기: 600x450 (너비x높이)
[완료] 그레이스케일 변환 완료
[완료] 캐니 에지 검출 완료 (임계값: threshold1=100, threshold2=200)
[정보] 에지 픽셀 수: 12345 픽셀 / 전체 270000 픽셀
[완료] 허프 변환 직선 검출 완료: 23개의 직선 검출
[완료] 원본 이미지에 23개의 빨간색 직선 그리기 완료
